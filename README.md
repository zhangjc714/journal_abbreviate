...
- Add a small unit test or example `.bib` file.
- Make the script optionally update files in-place (with a `--in-place` flag).
- Support additional BibTeX fields or more advanced fuzzy matching.
...
- The `abbreviate.py` script and this `README.md` were generated by ChatGPT and adapted to work with the provided `journal_list.txt` mapping and to follow the normalization and replacement behavior described above.
